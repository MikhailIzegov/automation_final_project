...
def test_guest_can_add_product_to_basket(browser, promo_offer_number):
    ...
    page.open()
    page.should_be_product_page_promo_offer_url()
...
@pytest.mark.xfail
def test_guest_cant_see_success_message_after_adding_product_to_basket(browser):   # NEGATIVE TEST !
...
@pytest.mark.xfail
def test_message_disappeared_after_adding_product_to_basket(browser):  # NEGATIVE TEST !
    link = "http://selenium1py.pythonanywhere.com/catalogue/coders-at-work_207/"
    page = ProductPage(browser, link)
    page.open()
    page.should_be_product_page()
